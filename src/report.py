...
class Report():
    ...
    def __init__(self, save_report=False, file_path="report/") -> None:
        self.report_metrics = {}
    ...
    def save_report_file(self):
        ...
        filename_report = self.file_path +"_"+str(self.report_metrics["strategy"]) \
                            +"_"+str(self.report_metrics['init_period'])+"_" \
                            + str(self.report_metrics['init_period'])
